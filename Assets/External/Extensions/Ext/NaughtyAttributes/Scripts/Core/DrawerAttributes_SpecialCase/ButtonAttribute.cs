...
namespace NaughtyAttributes
{
    ...
    public class ButtonAttribute : SpecialCaseDrawerAttribute, IGroupAttribute
    {
        ...
        public ButtonAttribute(string text = null, EButtonEnableMode enabledMode = EButtonEnableMode.Always, int sp = 0, string name = "")
        {
            this.Text = text;
