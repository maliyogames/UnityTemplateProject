...
namespace NaughtyAttributes.Editor
{
    public abstract class SpecialCasePropertyDrawerBase
    {
        public void OnGUI(Rect rect, SerializedProperty property)
        {
            ...
            {
                OnGUI_Internal(rect, property, PropertyUtility.GetLabel(property), PropertyUtility.GetAttribute<ReorderableListAttribute>(property).Space);
            }
        ...
        protected abstract void OnGUI_Internal(Rect rect, SerializedProperty property, GUIContent label, int space);
